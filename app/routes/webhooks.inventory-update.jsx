            ...
            <table align="center" width="100%" style="max-width: 550px; background-color: #ffffff; border-radius: 24px; border-collapse: separate; overflow: hidden; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);">
              <tr>
                <td style="padding: 40px; text-align: center;">
                  ...
                  <p style="color: #4b5563; font-size: 16px; line-height: 24px;">Good news! The item you were waiting for is back in stock and ready to ship.</p>
                </td>
              </tr>
              <tr>
                <td style="padding: 0 40px;">
                  <div style="background-color: #f9fafb; border: 1px solid #f3f4f6; border-radius: 20px; padding: 30px; text-align: center;">
                    <img src="${productImg}" alt="${variant.product.title}" style="width: 100%; max-width: 280px; height: auto; border-radius: 12px; margin-bottom: 25px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                    ...
                    <a href="${productUrl}" style="display: inline-block; background-color: #111827; color: #ffffff; padding: 18px 45px; border-radius: 15px; text-decoration: none; font-weight: bold; font-size: 16px;">Secure Yours Now</a>
                  </div>
                </td>
              </tr>
              <tr>
      ...
      const adminHtml = `
        <div style="font-family: sans-serif; padding: 30px; background-color: #fffafb; border: 1px solid #fee2e2; border-radius: 16px; max-width: 500px; margin: 20px auto;">
          <div style="display: flex; align-items: center; margin-bottom: 20px;">
            <div style="background-color: #fee2e2; color: #ef4444; width: 40px; height: 40px; border-radius: 50%; text-align: center; line-height: 40px; font-size: 20px;">🚨</div>
            <h2 style="color: #991b1b; margin-left: 15px; font-size: 20px;">${settings.subjectLine}</h2>
          </div>
          ...
          <div style="margin-top: 25px; text-align: center;">
            <a href="https://${shop}/admin/products" style="background-color: #111827; color: white; padding: 12px 25px; border-radius: 10px; text-decoration: none; font-size: 14px; font-weight: bold;">Manage Inventory</a>
          </div>
        </div>
      `;
